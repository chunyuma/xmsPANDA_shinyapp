                                             ...
                                             bsModal("moreoptions1", "More options for figure", "optionbutton1", size = "large",
                                                     tags$div(
                                                       ...
                                                       conditionalPanel(
                                                         ...
                                                         column(width=6,
                                                                conditionalPanel(
                                                                  condition = "input.plottype=='type1'",
                                                                  numericInput(width="350px","x_axis_spacing_type1", "X axis spacing (0-1000 limit):", 200, min = 0, max = 1000)
                                                                ),
                                                                conditionalPanel(
                                                                  condition = "input.plottype=='type2'",
                                                                  numericInput(width="350px","x_axis_spacing_type2", "X axis spacing (0-1000 limit):", 20, min = 0, max = 1000)
                                                                )
                                                          ),
                                                         column(width=6,numericInput(width="350px","y_axis_spacing", "Y axis spacing (0-5 limit):", 1, min = 0, max = 5)),
